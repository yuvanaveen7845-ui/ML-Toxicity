...
const { getUsers, createUser, updateUser, deleteUser, resetPassword, getTeams, createTeam, updateTeam, bulkAssignUsers } = require('../controllers/adminController');
...
router.post('/users', authorize('hr', 'ceo', 'team_leader'), createUser);
router.put('/users/bulk-assign', authorize('hr', 'ceo'), bulkAssignUsers);
